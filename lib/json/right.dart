...
class Right {
  ...
  Right({
    ...
    this.discipline = const Permission("discipline", read: false, write: false),
    ...
    this.organisation = const Permission(
      "organisation",
      read: false,
      write: false,
    ),
  ...
  Right.fromJson(Map<String, dynamic> json)
    : club = Permission(
      ...
      discipline = Permission(
        "discipline",
        read: json['right_discipline_read'],
        write: json['right_discipline_write'],
      ),
      event = Permission(
        "event",
  ...
  Map<String, dynamic> toJson() => {
    ...
    'right_discipline_write': discipline.write,
    'right_discipline_read': discipline.read,
