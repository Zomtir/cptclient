    ...
    return Scaffold(
      ...
      body: AppBody(children: <Widget>[
        ...
        ListTile(
          ...
          title: Text("${AppLocalizations.of(context)!.labelVersion} ${navi.packageInfo!.version}"),
          subtitle: Text("${AppLocalizations.of(context)!.labelBuild} ${navi.packageInfo!.buildNumber}"),
        ),
        Text(
